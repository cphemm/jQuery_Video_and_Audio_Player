...
(function ($) {
	...
	mejs.MediaElementPlayer.prototype = {
		...
		setPlayerSize: function(width,height) {
			...
			// detect 100% mode - use currentStyle for IE since video_css() doesn't return percentages
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		enterFullScreen: function() {
			...
			t.container
				...
				.width('100%')
				.height('100%');
				//.video_css({position: 'fixed', left: 0, top: 0, right: 0, bottom: 0, overflow: 'hidden', width: '100%', height: '100%', 'z-index': 1000});
		...
		exitFullScreen: function() {
			...
			t.container
				...
				.width(normalWidth)
				.height(normalHeight);
				//.video_css({position: '', left: '', top: '', right: '', bottom: '', overflow: 'inherit', width: normalWidth + 'px', height: normalHeight + 'px', 'z-index': 1});
